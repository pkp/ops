...
!0,this.bind(b,function(c,d,e){var f=null;2<arguments.length&&(f=Array.prototype.slice.call(arguments,2));this.triggerPublicEvent_(b,f)}))};a.pkp.classes.Handler.prototype.switchViz=function(b){a(b.currentTarget).parent().parent().find("span").toggle()};a.pkp.classes.Handler.prototype.initializeTinyMCE=function(){if("undefined"!==typeof tinyMCE){var b=this.getHtmlElement().attr("id"),c=a.pkp.controllers.SiteHandler.prototype.tinymceParams_;c.defaultToolbar=c.defaultToolbar||c.toolbar;a("#"+b).find(".richContent").each(function(){var d=
a(this).attr("id"),e=a("<div></div>"),f=a("<div></div>"),k=a.pkp.controllers.SiteHandler.prototype.tinymceParams_;a(this).hasClass("fullRichContent")?k.toolbar=k.fullToolbar:a(this).hasClass("extendedRichContent")?k.toolbar=k.richToolbar:k.toolbar=k.defaultToolbar;tinyMCE.EditorManager.createEditor(d,k).render();if(a(this).hasClass("localizable")||a(this).hasClass("flag"))if(e.addClass("mceLocalizationIcon localizable"),e.attr("id","mceLocalizationIcon-"+d),a(this).wrap(f),a(this).parent().append(e),
a(this).hasClass("localizable"))e.addClass("mceGlobe");else if(a(this).hasClass("flag")&&(d=a(this).attr("class").split(" "),d.length))for(f=0;f<d.length;f++)if(d[f].match(/^flag_[a-z]{2}_[A-Z]{2}$/)){e.addClass(d[f]);break}})}};a.pkp.classes.Handler.prototype.triggerPublicEvent_=function(b,c){this.getHtmlElement().parent().trigger(b,c);this.eventBridge_&&a('[id^="'+this.eventBridge_+'"]').trigger(b,c)};a.pkp.classes.Handler.prototype.replaceWith=function(b){this.unbindGlobalAll();this.getHtmlElement().replaceWith(b)};
a.pkp.classes.Handler.prototype.replacePartialWith=function(b,c){a.pkp.classes.Handler.hasHandler(c)?a.pkp.classes.Handler.getHandler(c).replaceWith(b):(this.unbindPartial(c),c.replaceWith(b))};a.pkp.classes.Handler.prototype.html=function(b){this.unbindGlobalChildren();this.getHtmlElement().html(b)};a.pkp.classes.Handler.prototype.unbindPartial=function(b){a("*",b).each(function(){if(a.pkp.classes.Handler.hasHandler(a(this))){var c=a.pkp.classes.Handler.getHandler(a(this));c.callbackWrapper(c.unbindGlobalAll())}})};
...
apply_source_formatting:!1,toolbar:"copy paste | bold italic underline | link unlink code fullscreen | image | pkpTags",richToolbar:"copy paste | bold italic underline | bullist numlist | superscript subscript | link unlink code fullscreen | image | pkpTags",fullToolbar:"copy paste | blocks | bold italic underline | blockquote bullist numlist | superscript subscript | link unlink code fullscreen | image | pkpTags",block_formats:"Paragraph=p; Heading 2=h2; Heading 3=h3",statusbar:!1,content_css:a.pkp.app.tinyMceContentCSS,
browser_spellcheck:!0,contextmenu:!1,skin:"tinymce-5",license_key:"gpl",menubar:!1,sandbox_iframes:!1};"undefined"!==typeof a.pkp.plugins.generic.tinymceplugin&&"undefined"!==typeof a.pkp.plugins.generic.tinymceplugin.uploadUrl&&(b.paste_data_images=!0,b.relative_urls=!1,b.remove_script_host=!1,b.images_upload_handler=function(c,d){return new Promise(function(e,f){var k=new FormData;k.append("file",c.blob(),c.filename());a.ajax({method:"POST",url:a.pkp.plugins.generic.tinymceplugin.uploadUrl,data:k,
processData:!1,contentType:!1,headers:{"X-Csrf-Token":pkp.currentUser.csrfToken},success:function(g){e(g.url)},error:function(g){f(g.responseJSON.error)}})})});b="undefined"!==typeof a.pkp.plugins.generic.tinymceplugin&&typeof a.pkp.plugins.generic.tinymceplugin.tinymceParams?a.extend({},b,a.pkp.plugins.generic.tinymceplugin.tinymceParams):a.extend({},b);b.init_instance_callback=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized;b.setup=a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup;
a.pkp.controllers.SiteHandler.prototype.tinymceParams_=b;tinyMCE.init(b)}};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCEInitialized=function(b){a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id)).trigger("tinyMCEInitialized",[b])};a.pkp.controllers.SiteHandler.prototype.triggerTinyMCESetup=function(b){var c=a("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));c.attr("readonly")&&(a.pkp.controllers.SiteHandler.prototype.tinymceParams_.readonly=!0);c.attr("wordCount")&&0<c.attr("wordCount")&&
(a.pkp.controllers.SiteHandler.prototype.tinymceParams_.plugins.push("pkpwordcount"),a.pkp.controllers.SiteHandler.prototype.tinymceParams_.statusbar=!0);c.attr("dir")&&(a.pkp.controllers.SiteHandler.prototype.tinymceParams_.directionality=c.attr("dir"));c=c.attr("rows")||10;a.pkp.controllers.SiteHandler.prototype.tinymceParams_.height=(20*c).toString()+"px";b.on("init",function(d){var e=a("#"+d.id);var f=a("#"+d.id).attr("placeholder");if(""!==f){var k=a("<span></span>");k.html(f);k.addClass("mcePlaceholder");
k.attr("id","mcePlaceholder-"+d.id);d.target.getContent().length&&k.hide();d=a("<div></div>");d.addClass("mcePlaceholderParent");e.wrap(d);e.parent().append(k)}});b.on("activate",function(d){a("#mcePlaceholder-"+d.id).hide()});b.on("deactivate",function(d){d.target.getContent().length||a("#mcePlaceholder-"+d.id).show()});b.on("BeforeSetContent",function(d){var e=a.pkp.classes.TinyMCEHelper.prototype.getVariableMap("#"+a.pkp.classes.Helper.escapeJQuerySelector(b.id));d.content=d.content.replace(/\{\$([a-zA-Z]+)\}(?![^<]*>)/g,
function(f,k,g,n){return void 0!==e[k]?a.pkp.classes.TinyMCEHelper.prototype.getVariableElement(k,e[k],"#"+b.id).html():f})});b.on("GetContent",function(d){var e=a("<div>"+d.content+"</div>");e.find(".pkpTag").replaceWith(function(){return"{$"+a(this).attr("data-symbolic")+"}"});d.content=e.html()});b.on("FullscreenStateChanged init",function(d){d=d.target;var e=a(d.editorContainer);d.plugins.fullscreen&&(d.plugins.fullscreen.isFullscreen()?e.find(".tox-menubar").show():e.find(".tox-menubar").hide())})};
...
this;var d=function(){var e=a(this);c.unbindPartial(e);e.remove()};b.length&&(this.trivialTimer_=setTimeout(function(){var e;for(e in b){var f=a("#pkp_notification_"+b[e]);f.fadeOut(400,d)}},6E3))}})(jQuery);(function(a){a.pkp.controllers.form=a.pkp.controllers.form||{};a.pkp.controllers.form.FormHandler=function(b,c){var d;this.parent(b,c);if(!b.is("form"))throw Error("A form handler controller can only be bound to an HTML form element!");c.submitHandler&&(this.callerSubmitHandler_=c.submitHandler);b.find(".datepicker").each(function(){var e=a(this);e.datepicker({changeMonth:!0,changeYear:!0,altField:"#"+e.prop("id")+"-altField",altFormat:"yy-mm-dd",dateFormat:a("#"+e.prop("id")+"-altField").attr("data-date-format")});
...
fullName:c.reviewerName,email:c.reviewerEmail}))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler,a.pkp.classes.Handler);a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler.prototype.handleRefresh_=function(b,c,d){d&&this.replaceWith(d)};a.pkp.controllers.grid.users.reviewer.AdvancedReviewerSearchHandler.prototype.handleReviewerAssign_=function(b,c,d){a("#reviewerId").val(d.id);a('[id^="selectedReviewerName"]').text(d.fullName);a('[id^="selectedReviewerEmail"]').text(d.email?
"\u2014 "+d.email:"");a("#searchGridAndButton").hide();a("#regularReviewerForm").show();var e=a('#reviewerFormFooter [name="personalMessage"]');if(!e.val()){b=a('#reviewerFormFooter input[name="template"]');var f=a('#reviewerFormFooter select[name="template"]');var k=window.tinyMCE.EditorManager.get(e.attr("id"));e="";c.lastRoundReviewerIds.includes(d.id)?(e="REVIEW_REQUEST_SUBSEQUENT",f.find('[value="REVIEW_REQUEST"]').remove()):(e="REVIEW_REQUEST",f.find('[value="REVIEW_REQUEST_SUBSEQUENT"]').remove());
var g=c.reviewerMessages[e];k.setContent(g);b.val(e);k.on("activate",function(){k.getContent().length||k.setContent(g)});f.find('[value="'+e+'"]').prop("selected",!0)}}})(jQuery);(function(a){a.pkp.controllers.grid.users.reviewer.form=a.pkp.controllers.grid.users.reviewer.form||{};a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler=function(b,c){this.parent(b,c);b.change(this.callbackWrapper(this.handleFormChange));this.bind("urlInDivLoaded",this.handleFileListLoad_)};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler,a.pkp.controllers.form.UserFormHandler);a.pkp.controllers.grid.users.reviewer.form.EditReviewFormHandler.prototype.handleFormChange=
...
b=b.find('textarea[name="personalMessage"]');b=tinyMCE.EditorManager.get(b.attr("id"));!1!==c&&""!==c.content&&b.setContent(c.content);return c.status}})(jQuery);(function(a){a.pkp.controllers.grid.users.reviewer=a.pkp.controllers.grid.users.reviewer||{};a.pkp.controllers.grid.users.reviewer.form=a.pkp.controllers.grid.users.reviewer.form||{};a.pkp.controllers.grid.users.reviewer.form.ReviewerActionFormHandler=function(b,c){this.parent(b,c);c.templateUrl&&(this.templateUrl_=c.templateUrl);b.find("#template").change(this.callbackWrapper(this.selectTemplateHandler_))};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.reviewer.form.ReviewerActionFormHandler,
a.pkp.controllers.form.AjaxFormHandler);a.pkp.controllers.grid.users.reviewer.form.ReviewerActionFormHandler.prototype.templateUrl_=null;a.pkp.controllers.grid.users.reviewer.form.ReviewerActionFormHandler.prototype.selectTemplateHandler_=function(b,c){b=this.getHtmlElement();a.post(this.templateUrl_,b.find("#template").serialize(),this.callbackWrapper(this.updateTemplate),"json")};a.pkp.controllers.grid.users.reviewer.form.ReviewerActionFormHandler.prototype.updateTemplate=function(b,c){var d=this.getHtmlElement();
c=this.handleJson(c);if(!1===c)return!1;var e=c.content;if(null!==e&&"object"===typeof e){b=e.body||"";var f=e.variables}else b=e||"";d=d.find("textarea.richContent").first();e=tinyMCE.EditorManager.get(d.attr("id"));f&&d.attr("data-variables",JSON.stringify(f));""!==b&&(e?e.setContent(b):d.val(b));return c.status}})(jQuery);(function(a){a.pkp.controllers.grid.users.stageParticipant=a.pkp.controllers.grid.users.stageParticipant||{};a.pkp.controllers.grid.users.stageParticipant.StageParticipantGridHandler=function(b,c){this.parent(b,c);this.bind("dataChanged",function(){this.refreshGridHandler();a("#submissionEditorDecisionsDiv,#copyeditingEditorDecisionsDiv,[id^=reviewDecisionsDiv]").each(function(){a.pkp.classes.Handler.getHandler(a(this)).reload()})})};a.pkp.classes.Helper.inherits(a.pkp.controllers.grid.users.stageParticipant.StageParticipantGridHandler,
