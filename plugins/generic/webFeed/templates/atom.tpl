...
<feed xmlns="http://www.w3.org/2005/Atom">
	...
	<link rel="alternate" href="{url journal=$server->getPath()}" />
	...
	<generator uri="http://pkp.sfu.ca/ops/" version="{$systemVersion|escape}">Open Preprint Systems</generator>
