...
<div class="page page_catalog_category">
	...
	<div class="about_section{if $image} has_image{/if}{if $description} has_description{/if}">
		{if $image}
			<div class="cover" href="{url router=PKP\core\PKPApplication::ROUTE_PAGE page="preprints" op="fullSize" type="category" id=$category->getId()}">
				<img src="{url router=PKP\core\PKPApplication::ROUTE_PAGE page="preprints" op="thumbnail" type="category" id=$category->getId()}" alt="null" />
			</div>
		{/if}
