 ...
 *
 * @brief OPS base-seed endpoint.
 *
 * Bootstrap is a context scenario with the suite's shared roster attached, so it
 * inherits the OPS overlay (sections, the moderation settings) from
 * ServerScenarioController and only changes the route and idempotency rule.
 */
...
class TestBootstrapController extends ServerScenarioController
{
